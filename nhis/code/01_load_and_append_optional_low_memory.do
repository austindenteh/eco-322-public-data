...
*          starter variables needed by 02_clean_and_analyze.do plus any
...
*
* Usage:   Run from nhis/, nhis/code/, from the repo root, or set global
*          nhis_root.
********************************************************************************
...
*   do "$nhis_root/code/01_load_and_append_optional_low_memory.do"
*
