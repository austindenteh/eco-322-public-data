* =============================================================================
* 02_clean_1998.do — Clean and Analyze Ghana DHS 1998
* =============================================================================
...
*
* Input:  output/ghana_dhs_1998_working.dta
* Output: output/ghana_dhs_1998_analysis.dta
* =============================================================================
...
capture log close
log using "`out_dir'/02_clean_1998_log.txt", text replace

di as txt "============================================================"
di as txt "Ghana DHS 1998 — Clean and Analyze"
di as txt "============================================================"

use "`out_dir'/ghana_dhs_1998_working.dta", clear
...
di as txt "  NOTE: Literacy variable (v155) not available in 1998 — skipping."
...
di as txt "  NOTE: Health insurance questions (v481/v481c) not available in 1998."
di as txt "  NHIS was not created until 2003. Skipping insurance section."

* ==========================================================================
* SECTION 6: Region Labels (10 regions in 1998)
* ==========================================================================
...
di as txt "  NOTE: Wealth index (v190) not available in 1998. Skipping wealth section."
...
di _n as txt "============================================================"
di as txt "DESCRIPTIVE STATISTICS — Ghana DHS 1998"
di as txt "============================================================"
...
compress
save "`out_dir'/ghana_dhs_1998_analysis.dta", replace

di _n as txt "============================================================"
di as txt "Saved: `out_dir'/ghana_dhs_1998_analysis.dta"
di as txt "  N = " _N
di as txt "============================================================"
