* =============================================================================
* 02_clean_2022.do — Clean and Analyze Ghana DHS 2022
* =============================================================================
* This script loads the harmonized 2022 working dataset, creates analysis
* variables for demographics, education, health insurance, and other domains,
* and produces descriptive statistics.
*
* Ghana DHS 2022 (DHS Phase VIII)
* - 16 administrative regions (6 new regions created in 2019)
* - NHIS enrollment ~91% by 2022
*
* Input:  output/ghana_dhs_2022_working.dta
* Output: output/ghana_dhs_2022_analysis.dta
* =============================================================================
...
capture log close
log using "`out_dir'/02_clean_2022_log.txt", text replace

di as txt "============================================================"
di as txt "Ghana DHS 2022 — Clean and Analyze"
di as txt "============================================================"

use "`out_dir'/ghana_dhs_2022_working.dta", clear
...
replace age_group = 8 if inrange(age_years, 50, 59)
...
* ==========================================================================
* SECTION 6: Region Labels (16 regions in 2022 — post-2019 reorganization)
* ==========================================================================

di _n as txt "--- Section 6: Region Labels ---"

* Ghana's 2019 regional reorganization created 6 new regions from existing ones:
*   Western North (from Western), Ahafo + Bono East (from Brong Ahafo),
*   Oti (from Volta), Savannah + North East (from Northern)
label define region_lbl 1 "Western" 2 "Central" 3 "Greater Accra" 4 "Volta" ///
    5 "Eastern" 6 "Ashanti" 7 "Western North" 8 "Ahafo" 9 "Bono" ///
    10 "Bono East" 11 "Oti" 12 "Northern" 13 "Savannah" 14 "North East" ///
    15 "Upper East" 16 "Upper West"
label values region region_lbl

* Northern vs Southern Ghana (using new 16-region mapping)
* Northern zone: Northern, Savannah, North East, Upper East, Upper West
gen byte northern = inlist(region, 12, 13, 14, 15, 16)
label var northern "Northern Ghana (Northern, Savannah, North East, Upper East, Upper West)"
...
di _n as txt "============================================================"
di as txt "DESCRIPTIVE STATISTICS — Ghana DHS 2022"
di as txt "============================================================"
...
compress
save "`out_dir'/ghana_dhs_2022_analysis.dta", replace

di _n as txt "============================================================"
di as txt "Saved: `out_dir'/ghana_dhs_2022_analysis.dta"
di as txt "  N = " _N
di as txt "============================================================"
