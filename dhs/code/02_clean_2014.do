* =============================================================================
* 02_clean_2014.do — Clean and Analyze Ghana DHS 2014
* =============================================================================
...
*
* Input:  output/ghana_dhs_2014_working.dta
* Output: output/ghana_dhs_2014_analysis.dta
* =============================================================================
...
capture log close
log using "`out_dir'/02_clean_2014_log.txt", text replace

di as txt "============================================================"
di as txt "Ghana DHS 2014 — Clean and Analyze"
di as txt "============================================================"

use "`out_dir'/ghana_dhs_2014_working.dta", clear
...
* ==========================================================================
* SECTION 6: Region Labels (10 regions in 2014)
* ==========================================================================
...
di _n as txt "============================================================"
di as txt "DESCRIPTIVE STATISTICS — Ghana DHS 2014"
di as txt "============================================================"
...
compress
save "`out_dir'/ghana_dhs_2014_analysis.dta", replace

di _n as txt "============================================================"
di as txt "Saved: `out_dir'/ghana_dhs_2014_analysis.dta"
di as txt "  N = " _N
di as txt "============================================================"
