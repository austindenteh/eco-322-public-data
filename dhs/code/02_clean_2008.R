# =============================================================================
# 02_clean_2008.R — Clean and Analyze Ghana DHS 2008
# =============================================================================
...
#
# Input:  output/ghana_dhs_2008_working.rds (or .dta from Stata)
# Output: output/ghana_dhs_2008_analysis.rds
#         output/ghana_dhs_2008_analysis_from_R.dta
# =============================================================================
...
sink(file.path(out_dir, "02_clean_2008_R_log.txt"), split = TRUE)
cat("============================================================\n")
cat("Ghana DHS 2008 -- Clean and Analyze (R)\n")
cat("============================================================\n\n")

# Load data (prefer .rds from R, fall back to .dta from Stata)
rds_file <- file.path(out_dir, "ghana_dhs_2008_working.rds")
dta_file <- file.path(out_dir, "ghana_dhs_2008_working.dta")
...
if (file.exists(rds_file)) {
  ...
  stop("Working dataset not found. Run 01_load_2008 first.")
}
...
# ==========================================================================
# SECTION 6: Region (10 regions in 2008)
# ==========================================================================

cat("--- Section 6: Region ---\n")

region_labels_2008 <- c(
...
dhs <- dhs %>%
  mutate(
    region_name = region_labels_2008[as.character(region)],
...
cat("\n============================================================\n")
cat("DESCRIPTIVE STATISTICS -- Ghana DHS 2008\n")
cat("============================================================\n")
...
saveRDS(dhs, file.path(out_dir, "ghana_dhs_2008_analysis.rds"))
write_dta(dhs %>% select(-region_name), file.path(out_dir, "ghana_dhs_2008_analysis_from_R.dta"))

cat(sprintf("\n============================================================\n"))
cat(sprintf("Saved: %s\n", file.path(out_dir, "ghana_dhs_2008_analysis.rds")))
cat(sprintf("  N = %d\n", nrow(dhs)))
cat("============================================================\n")
