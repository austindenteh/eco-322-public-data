* =============================================================================
* 02_clean_1993.do — Clean and Analyze Ghana DHS 1993
* =============================================================================
...
*
* Input:  output/ghana_dhs_1993_working.dta
* Output: output/ghana_dhs_1993_analysis.dta
* =============================================================================
...
capture log close
log using "`out_dir'/02_clean_1993_log.txt", text replace

di as txt "============================================================"
di as txt "Ghana DHS 1993 — Clean and Analyze"
di as txt "============================================================"

use "`out_dir'/ghana_dhs_1993_working.dta", clear
...
di as txt "  NOTE: Literacy variable (v155) not available in 1993 — skipping."
...
di as txt "  NOTE: Health insurance questions (v481/v481c) not available in 1993."
di as txt "  NHIS was not created until 2003. Skipping insurance section."

* ==========================================================================
* SECTION 6: Region Labels (10 regions in 1993)
* ==========================================================================
...
di as txt "  NOTE: Wealth index (v190) not available in 1993. Skipping wealth section."
...
di _n as txt "============================================================"
di as txt "DESCRIPTIVE STATISTICS — Ghana DHS 1993"
di as txt "============================================================"
...
* 8g. Region
di _n as txt "--- 8g. Region ---"
tab region female, m

* 8h. Summary means (excluding literate, poor, insurance — not available)
di _n as txt "--- 8h. Summary Means ---"
summarize female urban age_years educ_none educ_primary educ_second educ_higher ///
    in_union employed

di _n as txt "--- 8i. Summary Means by Sex ---"
di as txt "=== Women ==="
...
compress
save "`out_dir'/ghana_dhs_1993_analysis.dta", replace

di _n as txt "============================================================"
di as txt "Saved: `out_dir'/ghana_dhs_1993_analysis.dta"
di as txt "  N = " _N
di as txt "============================================================"
