* =============================================================================
* 01_load_1998.do — Load Ghana DHS 1998 Individual and Men's Recodes
* =============================================================================
...
* Output: output/ghana_dhs_1998_working.dta
* =============================================================================
...
local dhs_root ".."
local raw_dir  "`dhs_root'/data/raw/ghana_1998"
local out_dir  "`dhs_root'/output"

* Auto-detect file paths (DHS downloads may use different subfolder names)
local women_file "`raw_dir'/GHIR41DT/GHIR41FL.DTA"
local men_file   "`raw_dir'/GHMR41DT/GHMR41FL.DTA"
...
* --- Log ------------------------------------------------------------------
capture log close
log using "`out_dir'/01_load_1998_log.txt", text replace

di as txt "============================================================"
di as txt "Ghana DHS 1998 — Load and Harmonize"
di as txt "============================================================"
...
gen literacy        = .             // v155 does NOT exist in 1998
gen wealth_index    = .             // v190 does NOT exist in 1998
gen religion        = v130
gen ethnicity       = v131
...
gen any_insurance   = .             // v481 does NOT exist in 1998
gen nhis_enrolled   = .             // v481c does NOT exist in 1998 (NHIS not yet created)
...
gen literacy        = .             // mv155 does NOT exist in 1998
gen wealth_index    = .             // mv190 does NOT exist in 1998
gen religion        = mv130
gen ethnicity       = mv131
gen marital_status  = mv501
gen ever_married    = mv502
gen working_now     = mv714
gen any_insurance   = .             // mv481 does NOT exist in 1998
gen nhis_enrolled   = .             // mv481c does NOT exist in 1998
...
label var literacy        "Literacy — NOT AVAILABLE in 1998"
label var wealth_index    "Wealth index — NOT AVAILABLE in 1998"
...
label var any_insurance   "Health insurance — NOT AVAILABLE in 1998"
label var nhis_enrolled   "NHIS enrollment — NOT AVAILABLE in 1998"
...
assert inlist(interview_year, 1998, 1999)   // fieldwork spanned late 1998 into early 1999
...
* --- Save -----------------------------------------------------------------
compress
save "`out_dir'/ghana_dhs_1998_working.dta", replace

di _n as txt "============================================================"
di as txt "Saved: `out_dir'/ghana_dhs_1998_working.dta"
