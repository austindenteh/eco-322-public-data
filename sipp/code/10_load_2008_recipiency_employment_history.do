...
* global sipp_tm_recip_emp_waves "1"
*
* Optional settings passed to the shared topical loader:
* global sipp_2008_tm_n_max 1000
* global sipp_2008_tm_allocs 1
* global sipp_2008_tm_extra_vars "ACURSSI"

if "$sipp_tm_recip_emp_waves" == "" {
    global sipp_tm_recip_emp_waves "1"
}

global sipp_2008_tm_waves "$sipp_tm_recip_emp_waves"
global sipp_2008_tm_family_tag "recipiency_employment_history"
global sipp_2008_tm_family_label "Recipiency history, employment history, and tax rebates"
global sipp_2008_tm_family_note "Family-tagged topical extract for wave 1; it is not a harmonized cleaner."
